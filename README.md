...
The presented code belongs to the investigation from a **on review** paper. The arXiv version can be found as: [FreDSNet: Joint Monocular Depth and Semantic Segmentation with Fast Fourier Convolutions](https://arxiv.org/abs/2210.01595).
